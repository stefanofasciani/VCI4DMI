...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 503.0, 18.0, 430.0, 420.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 323.775269, 250.0, 126.014412, 17.0 ],
					"persistence" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 281.887634, 341.0, 150.0, 74.0 ],
					"text" : "N=length(xk);\nE=0:(N-1);\nE=E'*E;\nT=E.*(2*pi/N);\n[Wre,~]=pol2cart(T,1);\nixk=(xk*Wre).*(1/N);"
				}
