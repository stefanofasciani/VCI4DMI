function [rt,slope,yintercept] = sfa_t60(impulse,S_Rate,flag)
...
begin = round(S_Rate * .01);	%assume slope extends to at least 50 ms
...
%rt = round(abs(60/slope(1))-yintercept); %ORIGINAL
