function d=drectangle5D_sfa(p,x1,x2,y1,y2,z1,z2,t1,t2,k1,k2)
...
d=-min(min(min(min(min(min(min(min(min(-k1+p(:,5),k2-p(:,5)),-t1+p(:,4)),t2-p(:,4)),-z1+p(:,3)),z2-p(:,3)),-y1+p(:,2)),y2-p(:,2)),-x1+p(:,1)),x2-p(:,1));